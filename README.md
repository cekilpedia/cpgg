...
![Contributors](https://img.shields.io/github/contributors/cekilpedia/autoscript?style=for-the-badge)
...
```bash
bash <(curl -s https://raw.githubusercontent.com/cekilpedia/autoscript/development/install.sh)
```
...
This script was created and is being maintained by [CEKIL - XD](https://github.com/cekilpedia).

<h1 align="center">Extra informations</h1>

If you have any ideas, or suggestions, feel free to say so in the [Support Group](https://discord.gg/cekilpedia).
